...
<?php
  ...
  <section class="container-fluid row">
    ...
    <div class="card-body">
      <?php
      $mod3 = $_GET['modFor'];
      $sqlcon3= "SELECT usuario.nombre,usuario.apellido1,usuario.apellido2, promocion.promocion, promocion.fk_promoyear
      ...
      <form method="post">
            <div class="form-group">
              ...
              <input type="text" name="nomc" class="form-control v24" id="nombrefor"  value=" <?php echo $a3[0]; ?>">
              <span id="mensajenomfor"></span>
            </div>
            <div class="form-group">
              <label for="formGroupExampleInput2">1º Apellido</label>
              <input type="text" name="apec1" class="form-control v50" id="apellidofor1"  value=" <?php echo $a3[1]; ?>">
              <span id="mensajapefor1"></span>
            </div>
            <div class="form-group">
              <label for="formGroupExampleInput2">2º Apellido</label>
              <input type="text" name="apec2" class="form-control v50"  id="apellidofor2" value=" <?php echo $a3[2]; ?>">
              <span id="mensajapefor2"></span>
            </div>
            <div class="form-row">
              <div class="col">
            ...
            <div class="col-xs-12 col-md-12 col-lg-12 ">
              <div class="modal-footer border-0">
                <a href="formador.php" class="btn btn-secondary">Cancelar</a>
          ...
          $update2 ="UPDATE userhist SET statusUserhist = '0'
          WHERE fk_usuario = '$mod3'";
  ...
  <section class="container-fluid row">
    ...
    <div class="card-body">
      ...
      <form method="post">
            <div class="form-group">
              <label for="formGroupExampleInput">Nombre</label>
              <input type="text" name="nomc" class="form-control v24" id="nombrefor" required  value=" <?php echo $a3[0]; ?>" required>
              <span id="mensajenomfor"></span>
            </div>
            <div class="form-group">
              <label for="formGroupExampleInput2">1º Apellido</label>
              <input type="text" name="apec1" class="form-control v50" id="apellidofor1" required value=" <?php echo $a3[1]; ?>" required >
              <span id="mensajapefor1"></span>
            </div>
            <div class="form-group">
              <label for="formGroupExampleInput2">2º Apellido</label>
              <input type="text" name="apec2" class="form-control v50" id="apellidofor2" required value=" <?php echo $a3[2]; ?>" required>
              <span id="mensajapefor2"></span>
            </div>
            <div class="form-row">
              <div class="col">
  ...
  ?>
    ...
    <script type="text/javascript" src="js/validarformador.js"></script>
</body>
</html>