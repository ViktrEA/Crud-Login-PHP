      ...
      <header>
        <nav class="nav d-inline-flex p-2 d-flex justify-content-between nav-tabs border-bottom border-danger cabecera container-fluid">
          ...
          <ul class="nav justify-content-center align-self-center">
            ...
            <li class="nav-item">
              <a class="btn btn-outline-danger border-0 active" href="formador.php">FORMADOR</a>
            </li>
            <li class="nav-item">
      ...
      <section class="container">
        <div class="row" id="tablafabrica">
          <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="col-md-12">
              <br>
              <h1 class="text-danger pull-left">FORMADOR</h1>
              <br>
            </div>
            <br>
            ...
            <table id="tablarespons" class="table table-striped table-bordered">
              <thead>
                <tr class="bg-primary text-white tituloTabla">
                  <th>Nombre
                    <a href="formador.php?order=<?php echo 'nom_asc'; ?>" class="text-reset"><i class="fa fa-sort-alpha-asc" aria-hidden="true"></i></a>
                    <a href="formador.php?order=<?php echo 'nom_dsc'; ?>" class="text-reset"><i class="fa fa-sort-alpha-desc" aria-hidden="true"></i></a>
                  </th>
                  <th>1ºApellido
                    <a href="formador.php?order=<?php echo 'ap1_asc'; ?>" class="text-reset"><i class="fa fa-sort-alpha-asc" aria-hidden="true"></i></a>
                    <a href="formador.php?order=<?php echo 'ap1_dsc'; ?>" class="text-reset"><i class="fa fa-sort-alpha-desc" aria-hidden="true"></i></a>
                  </th>
                  <th>2ºApellido
                    <a href="formador.php?order=<?php echo 'ap2_asc'; ?>" class="text-reset"><i class="fa fa-sort-alpha-asc" aria-hidden="true"></i></a>
                    <a href="formador.php?order=<?php echo 'ap2_dsc'; ?>" class="text-reset"><i class="fa fa-sort-alpha-desc" aria-hidden="true"></i></a>
                  </th>
                  <th>Promoción
                    <a href="formador.php?order=<?php echo 'prom_asc'; ?>" class="text-reset"><i class="fa fa-sort-alpha-asc" aria-hidden="true"></i></a>
                    <a href="formador.php?order=<?php echo 'prom_dsc'; ?>" class="text-reset"><i class="fa fa-sort-alpha-desc" aria-hidden="true"></i></a>
                  </th>
                  <th>Periodo
                    <a href="formador.php?order=<?php echo 'per_asc'; ?>" class="text-reset"><i class="fa fa-sort-alpha-asc" aria-hidden="true"></i></a>
                    <a href="formador.php?order=<?php echo 'per_dsc'; ?>" class="text-reset"><i class="fa fa-sort-alpha-desc" aria-hidden="true"></i></a>
                  </th>
                  <th>Status
                    <a href="formador.php?order=<?php echo 'sta_asc'; ?>" class="text-reset"><i class="fa fa-sort-alpha-asc" aria-hidden="true"></i></a>
                    <a href="formador.php?order=<?php echo 'sta_dsc'; ?>" class="text-reset"><i class="fa fa-sort-alpha-desc" aria-hidden="true"></i></a>
                  </th>
              ...
              while ($a = mysqli_fetch_array($r)) { ?>
                <tr>
                  ...
                  <td>
                    <a href="modificarFormador.php?modFor=<?php echo $a[5]; ?>"><i class="fa fa-pencil-square-o fa-2x bg-transparent text-danger" aria-hidden="true"></i></a>
                      ...
                      <div class="modal-dialog modal-dialog-centered w-25" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer border-0">
                            ...
                            <a href="delete.php?simpDeleteForm=<?php echo $a[5]; ?>" class="btn btn-danger" id="enviarf" type="submit">Eliminar</a>
                          </div>
                        </div>
                        </form>
                      </div>
        ...
        <div class="row" id="tablafabrica">
          <div class="col-xs-12 col-md-12 col-lg-12">
            ...
            <table id="tablarespons" class="table table-striped table-bordered">
              ...
              $con_res = "SELECT usuario.nombre,usuario.apellido1,usuario.apellido2, promocion.promocion, 
                  promoyear.promocion,usuario.id_usuario, userhist.statusUserhist
                  FROM usuario 
                  LEFT JOIN userhist 
                  ON userhist.fk_usuario = usuario.id_usuario 
                  LEFT JOIN promocion 
                  ON userhist.fk_promo = promocion.id_promocion
                  INNER JOIN promoyear
                  ON promoyear.id_promoyear = promocion.fk_promoyear
                  WHERE usuario.cargo='f' and userhist.statusUserhist='1' OR
                  userhist.fk_promo IN
                  (SELECT userhist.fk_promo FROM userhist WHERE userhist.fk_usuario='$_SESSION[id]' AND userhist.statusUserhist=0) 
                  and usuario.cargo = 'f' $con $ord";
              $r = mysqli_query($link, $con_res);
              while ($a = mysqli_fetch_array($r)) { ?>
                <tr>
                  <td><?php echo $a[0]; ?> </td>
